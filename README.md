...
This is a plugin for Goobi workflow which allows to prepare the delivery of ordered digitisation requests to the user and to the finance department for invoicing. It allows to let users enter a GUI to decide pricing.
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_step_zbz_order_delivery
