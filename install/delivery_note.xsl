			...
			<fo:page-sequence master-reference="A4">
				<fo:flow flow-name="xsl-region-body" font-family="georgia, opensans, unicode" font-size="9pt" >
					...
					<fo:block text-align="left" font-weight="bold" font-size="14pt" margin-top="25pt" margin-bottom="30pt">
				         <xsl:text>Lieferschein Digitalisierungszentrum</xsl:text>
					</fo:block>
					<!-- // HEADER -->
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell background-color="#dddddd" padding="3pt" border-width="1pt" border-style="solid" border-color="#bbb">
									<fo:block>Anzahl der Scans:</fo:block>
								</fo:table-cell>
								<fo:table-cell padding="3pt" border-width="1pt" border-style="solid" border-color="#bbb">
									<fo:block>
										<xsl:value-of select="//processFiles"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<!-- // PROCESS FILES -->
					...
					<fo:block text-align="left" font-size="9pt" margin-top="20pt">
				         <xsl:text>Vielen Dank für Ihre Bestellung.</xsl:text>
					</fo:block>
					<fo:block text-align="left" font-size="9pt" margin-top="15pt">
				    	 <xsl:text>Mit freundlichen Grüßen</xsl:text>
					</fo:block>
					<fo:block text-align="left" font-size="9pt" margin-top="2pt">
				    	 <xsl:text>Ihr Digiz-Team</xsl:text>
					</fo:block>
